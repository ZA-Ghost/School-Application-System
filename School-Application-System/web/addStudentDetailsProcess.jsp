...
<html>
	...
	INSERT INTO registration (name, surname, birthday, identity_number, gender, ethnicity, email, phone, grade, branch, street_name, suburb, city, province, guardian_name, guardian_surname, identityNumber, guardian_number, guardian_email, relationship)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?);
