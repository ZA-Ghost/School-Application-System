...
<sql:query dataSource="${schoolRegistrationIS}" var="result">
    ...
    <div class="container">
       ...
       <div class="content-container">
            <h1>Student Application Management: Grade 10</h1>
            <table>
                <tr>
                    <th>Name</th>
                    <th>Grade</th>
            ...
            <td><a href="viewApplicationDetails.jsp?id=<c:out value="${row.id}"/>">Review Application</a></td>
            </tr><c:out value="${row.surname}"/>
